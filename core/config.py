...
class ConfigManager:
    public_keys = {
        ...
        "thread_creation_self_contact_response": "You have opened a Supportly thread.",
        "thread_creation_contact_response": "{creator.name} has opened a Supportly thread.",
        ...
        "thread_close_response": "{closer.mention} has closed this Supportly thread.",
        "thread_self_close_response": "You have closed this Supportly thread.",
        ...
        "private_added_to_group_response": "{moderator.name} has added you to a Supportly thread.",
        "private_added_to_group_description_anon": "A moderator has added you to a Supportly thread.",
        "public_added_to_group_title": "New User",
        "public_added_to_group_response": "{moderator.name} has added {users} to the Supportly thread.",
        "public_added_to_group_description_anon": "A moderator has added {users} to the Supportly thread.",
        "private_removed_from_group_title": "Removed From Thread (Group)",
        "private_removed_from_group_response": "{moderator.name} has removed you from the Supportly thread.",
        "private_removed_from_group_description_anon": "A moderator has removed you from the Supportly thread.",
        "public_removed_from_group_title": "User Removed",
        "public_removed_from_group_response": "{moderator.name} has removed {users} from the Supportly thread.",
        "public_removed_from_group_description_anon": "A moderator has removed {users} from the Supportly thread.",
        # moderation
