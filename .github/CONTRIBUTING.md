...
If you are proposing new features, please discuss them with us in the [support server](https://discord.gg/25YRFavwpj) before you start working on them!
...
## Report bugs using [Github Issues](https://github.com/justsadnyx-ux/supportly/issues)
We use GitHub issues to track public bugs. Report a bug by [opening a new Issue](https://github.com/justsadnyx-ux/supportly/issues/new); it's that easy!

## Find pre-existing issues to tackle
Check out our [issue tracker](https://github.com/justsadnyx-ux/supportly/issues?q=is%3Aissue+is%3Aopen) and start helping out!
